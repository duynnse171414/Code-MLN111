...
// Load intro content immediately when page loads
function loadIntroContent() {
    const contentContainer = document.getElementById('content-container');
    if (contentContainer && contentData.intro) {
        const introSection = document.createElement('section');
        introSection.id = 'intro';
        introSection.className = 'content-section active';
        introSection.innerHTML = `
            <h2>${contentData.intro.title}</h2>
            ${contentData.intro.content}
        `;
